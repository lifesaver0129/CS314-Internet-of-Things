            ...
            $.ajax({
                ...
                success: function (data) {
                    for (i = 0; i < data.length; i++) {
                        var s = data[i];
                        // $('#' + s.sy_di_code + '1').text(s.se_hr_id);
                        // $('#' + s.sy_di_code + '2').text(s.se_hr_time);
                        // $('#' + s.sy_di_code + '3').text(s.se_hr_tem);
                        // $('#' + s.sy_di_code + '4').text(s.se_hr_hum);
                        // $('#' + s.sy_di_code + '5').text(s.se_hr_pressure);
                    }
                }
            })
        }
